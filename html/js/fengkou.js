...
var prefix_only = [ "细粒度", "新旧动能转换下的", "存在性", "高通量", "普惠", "泛", "海绵型", "实时", "绿色", "海洋", "热", "冷", "湿", "可逆", "全天候", "全方位", "共享", "精准", "沉浸式", "透明", "扁平", "海量", "一带一路", "自主", "可控", "弹性", "平台型", "可信", "万物", "自动", "智慧", "未来", "数字", "无人", "硬", "高", "重", "轻", "轻量", "快", "慢", "快速", "高速", "强", "新", "软", "黑", "灰度", "多", "e", "i", "和谐", "确保", "深度", "行为", "动态", "静态", "可持续", "大规模", "全面", "现代", "理论" ];
